...
class TelegramLog(models.Model):
    ...
    target = models.ForeignKey(User, related_name="log_as_target", null=True, on_delete=models.SET_NULL)
    issuer = models.ForeignKey(User, related_name="log_as_issuer", null=True, on_delete=models.SET_NULL)
